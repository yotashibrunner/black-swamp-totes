...
const CUSTOMERS = [
  { key: 'marcus', name: 'Marcus Webb', email: 'test+marcus@example.test', phone: '(419) 555-0142' },
  { key: 'dana', name: 'Dana Reyes', email: 'test+dana@example.test', phone: '(419) 555-0173' },
  { key: 'sam', name: 'Sam Okafor', email: 'test+sam@example.test', phone: '(567) 555-0198' },
];
